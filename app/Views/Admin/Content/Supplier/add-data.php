                    ...
                    <form action="<?= site_url('supplier/data-supplier') ?>" method="post">
                        ...
                        <?= csrf_field() ?>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" id="exampleInputName" placeholder="Enter Supplier Name">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputName">Hp</label>
                                <input type="text" class="form-control" name="hp" id="exampleInputName" placeholder="Enter Supplier Hp">
                            </div>
                        <!-- /.card-body -->
                        </div>
